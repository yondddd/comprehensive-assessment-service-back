...
import com.lm.assessment.common.utils.json.adapter.jackson.DateDeserializer;
import com.lm.assessment.common.utils.json.adapter.jackson.LocalDateTimeDeserializer;
import com.lm.assessment.common.utils.json.adapter.jackson.LocalDateTimeSerializer;
...
public class JsonUtils {
    ...
    public static <T> RemoteResponse<T> toResponse(String json, Class<T> clazz) {
        JavaType javaType = getDefaultMapper().constructParametricType(RemoteResponse.class, clazz);
        return DEFAULT_MAPPER.fromJson(json, javaType);
    }

    public static <T> RemoteResponse<T> toResponse(String json, JavaType javaType) {
        return DEFAULT_MAPPER.fromJson(json, javaType);
    }

    public static <T> PageableResponse<T> toPageableResponse(String json, Class<T> clazz) {
        JavaType javaType = getDefaultMapper().constructParametricType(PageableResponse.class, clazz);
        return DEFAULT_MAPPER.fromJson(json, javaType);
    }

    public static <T> PageableResponse<T> toPageableResponse(String json, JavaType javaType) {
        return DEFAULT_MAPPER.fromJson(json, javaType);
    }
