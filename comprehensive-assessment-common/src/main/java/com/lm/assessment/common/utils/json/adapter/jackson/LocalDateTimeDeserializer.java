package com.lm.assessment.common.utils.json.adapter.jackson;
...
import com.lm.assessment.common.utils.json.adapter.DateAdapter;
...
public class LocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> implements DateAdapter {
    ...
    private SimpleDateFormat yearDateFormat = new SimpleDateFormat("yyyy");
